...
public:
	...
	void run(char const *host, char const *port, char const *target,
		...
		//SSL_set_cipher_list(stream_.native_handle(), "ALL");
		//SSL_clear_options(stream_.native_handle(), SSL_OP_NO_SSLv2);
		//SSL_set_options(stream_.native_handle(), SSL_OP_NO_SSLv3);
